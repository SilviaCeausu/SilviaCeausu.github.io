...
Check out the [CBER Lunchbox Podcast](https://www.youtube.com/playlist?list=PLKYTvTbXFuChwnj9kVKqVl5XPZrU9P7bk), season 2. In episode 3 of this season, I am chatting with Josep (Pep) Serra-Diaz who is an assistant professor at AgriParisTech in France. After getting his PhD from the Autonomous University of Barcelona, Pep started a journey that included several postdocs and ended up taking his research on vegetation dynamics from local to global scale, from experiments to models and big data. We discuss real-world impact as an academic, his journey from research assistant to engineering company to PhD, and the challenges of translating science into forest management actions. We also discuss teaching translational ecology, researching across different academic systems, the advantages and disadvantages of the French engineering school system and being gay in academia.
